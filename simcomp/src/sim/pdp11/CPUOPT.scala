...
protected object CPUOPT {
  ...
  val cpu_tab: Array[CPUTAB] = Array(
    pdp11.CPUTAB("11/03", SOP_1103, OPT_1103, PDP11.MEMSIZE64K, PSW_1103, UInt(0), UInt(0), UInt(0), UInt(0), UInt(0)),
    pdp11.CPUTAB("11/04", SOP_1104, OPT_1104, PDP11.MEMSIZE64K, PSW_1104, UInt(0), UInt(0), UInt(0), UInt(0), UInt(0)),
    pdp11.CPUTAB("11/05", SOP_1105, OPT_1105, PDP11.MEMSIZE64K, PSW_1105, UInt(0), UInt(0), UInt(0), UInt(0), UInt(0)),
    pdp11.CPUTAB("11/20", SOP_1120, OPT_1120, PDP11.MEMSIZE64K, PSW_1120, UInt(0), UInt(0), UInt(0), UInt(0), UInt(0)),
    pdp11.CPUTAB("11/23", SOP_1123, OPT_1123, PDP11.MAXMEMSIZE, PSW_F, MFPT_F, PAR_F, PDR_F, MM0_F, MM3_F),
    pdp11.CPUTAB("11/23+", SOP_1123P, OPT_1123P, PDP11.MAXMEMSIZE, PSW_F, MFPT_F, PAR_F, PDR_F, MM0_F, MM3_F),
    pdp11.CPUTAB("11/24", SOP_1124, OPT_1124, PDP11.MAXMEMSIZE, PSW_F, MFPT_F, PAR_F, PDR_F, MM0_F, MM3_F),
    pdp11.CPUTAB("11/34", SOP_1134, OPT_1134, PDP11.UNIMEMSIZE, PSW_1134, UInt(0), PAR_1134, PDR_1134, MM0_1134, UInt(0)),
    pdp11.CPUTAB("11/40", SOP_1140, OPT_1140, PDP11.UNIMEMSIZE, PSW_1140, UInt(0), PAR_1140, PDR_1140, MM0_1140, UInt(0)),
    pdp11.CPUTAB("11/44", SOP_1144, OPT_1144, PDP11.MAXMEMSIZE, PSW_1144, MFPT_44, PAR_1144, PDR_1144, MM0_1144, MM3_1144),
    pdp11.CPUTAB("11/45", SOP_1145, OPT_1145, PDP11.UNIMEMSIZE, PSW_1145, UInt(0), PAR_1145, PDR_1145, MM0_1145, MM3_1145),
    pdp11.CPUTAB("11/60", SOP_1160, OPT_1160, PDP11.UNIMEMSIZE, PSW_1160, UInt(0), PAR_1160, PDR_1160, MM0_1160, UInt(0)),
    pdp11.CPUTAB("11/70", SOP_1170, OPT_1170, PDP11.MAXMEMSIZE, PSW_1170, UInt(0), PAR_1170, PDR_1170, MM0_1170, MM3_1170),
    pdp11.CPUTAB("11/73", SOP_1173, OPT_1173, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/53", SOP_1153, OPT_1153, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/73B", SOP_1173B, OPT_1173B, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/83", SOP_1183, OPT_1183, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/84", SOP_1184, OPT_1184, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/93", SOP_1193, OPT_1193, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J),
    pdp11.CPUTAB("11/94", SOP_1194, OPT_1194, PDP11.MAXMEMSIZE, PSW_J, MFPT_J, PAR_J, PDR_J, MM0_J, MM3_J)
  )
